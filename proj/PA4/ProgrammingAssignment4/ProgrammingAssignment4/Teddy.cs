...
namespace ProgrammingAssignment4
{
    ...
    public class Teddy
    {
        ...
        public Teddy(Texture2D sprite, Vector2 location)
        {
            ...
            halfDrawRectangleWidth  = halfDrawRectangleWidth / 2;
        }
        ...
        public void SetTarget(Vector2 target)
        {
            ...
            // speed
            Vector2 targetVector = new Vector2(target.X - location.X, target.Y - location.Y);
            targetVector.Normalize();
            velocity.X = targetVector.X * BASE_SPEED;
            velocity.Y = targetVector.Y * BASE_SPEED;
        }
