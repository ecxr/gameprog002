...
namespace FishAndBears
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            destroy = Content.Load<SoundEffect>("zombie");
            bounce[0] = Content.Load<SoundEffect>("confetti");
            bounce[1] = Content.Load<SoundEffect>("pirate");

            // initialize menu objects
            mainMenu = new Menu(Content, WINDOW_WIDTH, WINDOW_HEIGHT);

            // initialize fish
            fish = new Fish(Content, "fish", WINDOW_WIDTH / 6, WINDOW_WIDTH / 6,
